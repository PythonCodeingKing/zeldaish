...
class Player:
	...
	def __init__(self, screen, tiles):
		self.nImage = pygame.image.load("other\\player.png")
		self.attacking_image = pygame.image.load("other\\player_attacking.png")
	...
	def update(self, enemies, nonPassables, items, game_active):
		for e in enemies:
